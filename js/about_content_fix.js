    ...
    const DESIRED_HTML = `
          <section class="px-6 py-8 md:px-8">
            <div class="mx-auto max-w-4xl space-y-4">
              ...
              <p class="leading-relaxed">
                ...
                advanced AI, computer vision, biometrics, IoT, and video
                analytics.
              </p>
              <p class="leading-relaxed">
                Founded in 2013 by two PhD-level experts in biometrics and
                artificial intelligence, <strong>Aeronix</strong> builds
                intelligent solutions that power critical operations across
                aviation, education, corrections, healthcare, government,
                mining, retail, and more.
              </p>
            </div>
          </section>
          <section class="px-6 py-8 md:px-8">
          ...
          <section class="px-6 py-8 md:px-8">
            <div class="mx-auto max-w-4xl space-y-4">
              ...
              <p class="leading-relaxed">
                At <strong>Aeronix</strong>, our mission is to effectively introduce the advanced technology products and services of Australian-based Aervision to the Turkish market, adding real-time, secure, and sustainable value to the operational processes of organizations operating in a wide range of sectors, from aviation to public sector, healthcare to education, mining to retail.
              </p>
              <p class="leading-relaxed">
                With our intelligent system integrations, local expertise, and strong service infrastructure, we offer solutions that reduce risks, increase operational efficiency, and enable organizations to move towards the future with greater confidence.
              </p>
            </div>
          </section>
          <section class="px-6 py-8 md:px-8">
            <div class="mx-auto max-w-4xl space-y-4">
              ...
              <p class="leading-relaxed">
                At <strong>Aeronix</strong>, our team combines deep expertise
                in computer vision, machine learning, and high-performance
                system development to build real-world AI solutions.
              </p>
              <p class="leading-relaxed">
                From startups to enterprise clients, we collaborate closely to
                deliver tailored biometrics, security, and surveillance
                technologies that meet the unique demands of each deployment.
              </p>
            </div>
          </section>
          <section class="px-6 py-8 md:px-8">
            <div class="mx-auto max-w-4xl space-y-4">
              ...
              <p class="leading-relaxed">
                Our products help organizations address two critical areas in
                safety and security: real-time situational awareness and secure
                access control.
              </p>
              <p class="leading-relaxed">
                The <strong>Aeronix</strong> AI platform delivers enhanced
                visualization and actionable intelligence, empowering security
                teams to elevate security, ensure compliance, and reduce risk.
              </p>
            </div>
          </section>
          <section class="px-6 py-8 md:px-8">
            <div class="mx-auto max-w-4xl space-y-4">
              ...
              <p class="leading-relaxed">
                We take pride in delivering technology that is both powerful and
                easy to use. Our team is committed to solving complex problems
                with precision, efficiency, and care.
              </p>
              <p class="leading-relaxed">
                From on-time delivery to exceptional after-sales support, our
                clients trust us to meet the highest standards of quality — all
                within budget.
              </p>
            </div>
          </section>`;
